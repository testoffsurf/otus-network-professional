...
```
R24(config)#router bgp 520
R24(config-router)#neighbor 100.0.0.10 remote-as 2042
R24(config-router)#exit
...
Neighbor        V           AS MsgRcvd MsgSent   TblVer  InQ OutQ Up/Down  State/PfxRcd
100.0.0.6       4          301      17      18        1    0    0 00:13:29        0
100.0.0.10      4         2042       4       2        1    0    0 00:00:26        0
</code></pre>
</details>

Мы видим что у маршрутизатора R24 два BGP-соседа: один сосед с IP-адресом 100.0.0.6 в автономной системе 301; второй сосед с IP-адресом 100.0.0.10 в автономной системе 2042.

### Организуете IP доступность между пограничным роутерами офисами Москва и С.-Петербург.
На пограничных маршрутизаторах в офисе Москва и С.-Петербург необходимо анонсировать соответствующие сети в процесс BGP, тоже самое необходимо сделать для каждого маршрутизатора в каждом из интернет провайдеров. Анонсирование сети в процесс BGP выполняется командой <b>network</b>:

```
device(config)#router bgp XXX
...
B        100.0.0.0/30 [20/0] via 100.0.0.9, 00:38:57
B        100.0.0.4/30 [20/0] via 100.0.0.9, 00:29:32
B        100.77.0.0/30 [20/0] via 100.0.0.9, 00:35:55
B        100.77.0.4/30 [20/0] via 100.0.0.9, 00:35:24
B        100.78.0.0/30 [20/0] via 100.0.0.9, 00:39:58
</code></pre>
</details>
