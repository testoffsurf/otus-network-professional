...
Предположим, что мы хотим трафик из VLAN 100 проходил через маршрутизатор R26. Для это воспользуемся конфигурационной командой ROUTE-MAP, где в качестве NEXT-HOP (укажем): 100.0.0.25.
![](pbr.png)
