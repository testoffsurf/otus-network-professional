...
Предположим, что мы хотим чтобы трафик из VLAN 100 проходил через маршрутизатор R26. Для этого мы пишем ROUTE-MAP, где указываем в качестве NEXT-HOP: 100.0.0.25. Наш ROUTE-MAP будет выглядить следующим образом:
