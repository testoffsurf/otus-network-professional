...
Предположим, что мы хотим трафик из VLAN 100 пропускать через маршрутизатор R26. Для этого мы пишем ROUTE-MAP, где укажим NEXT-HOP: 100.0.0.25. Наш ROUTE-MAP будет выглядить следующим образом:
