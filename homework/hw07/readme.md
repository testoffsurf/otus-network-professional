...
Paths: (2 available, best #2, table default)
  ...
  Refresh Epoch 2
  101 520 2042
    10.77.0.254 (metric 21) from 10.77.0.254 (10.77.0.254)
      Origin incomplete, metric 0, localpref 100, valid, internal
      rx pathid: 0, tx pathid: 0
  Refresh Epoch 2
  301 520 2042
...
Мы видим что в зависимости от маршрутизатора самый лучший путь до сети 10.78.0.24/30 меняется. Для маршрутизатора R14 через AS 101, 520, 2042; а для маршрутизатора R15 через AS 301, 520, 2042.<br>
<br>
Теперь применим ранее описанный <b>route-map</b> на входящие маршруты от интернет провайдера Ламас и посмотрим как у нас измениться картина в отношении наилучшего пути к сети 10.78.0.24/30:<br>
<br>
</code></pre>
</details>
<details>
...
После применения <b>route-map</b> картина кардинально поменялась в отношении лучшего пути к сети 10.78.0.24/30, на обоих маршрутизаторах наилучшим путем считается путь через AS 301, 520, 2042. Из чего можно сделать вывод что данное правило распространиться и на другие сети, а интернет провайдер Ламас станит приоритетным.
