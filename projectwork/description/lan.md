...
Работая над схемой текущей сетевой инфраструктуры мы попутно решали еще одну не мало важную задачу - это обследование состояния кабельной инфраструктуры. Наши усилия не были напрасными так как, попутно мы собирали информацию о том где и в каких условиях эксплуатируется сетевое оборудование и кабельная инфраструктура. В нашей работе были не только трудности, но и интересные, и забавные ситуации. Вот, например, 
