...
2.
3.
4.    определяем  разрешаем нужный трафик 
...
Конфигурирование NTP протокола на сетевом оборудовании Cisco производиться следующим образом:
    ...
    Для начала мы устанавливаем свою временную зону (для Московского часового пояса - +3 MSK); так же настраиваем периодическую синхронизацию календаря и времени clock, которое генерирует кварцевый резонатор, пока устройство Cisco включено:
